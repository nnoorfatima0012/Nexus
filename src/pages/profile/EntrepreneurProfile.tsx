...
//   const handleSendRequest = () => {
//     alert('Collaboration request API will be connected in the next module.');
//   };
...
//                   <h3 className="text-md font-medium text-gray-900">Solution</h3>
//                   <p className="text-gray-700 mt-1">
//                     {entrepreneur.pitchSummary || 'Solution details not added yet.'}
//                   </p>
//                 </div>
...
//                   <h3 className="text-md font-medium text-gray-900">Market Opportunity</h3>
//                   <p className="text-gray-700 mt-1">
//                     The {entrepreneur.industry || 'startup'} market is experiencing significant growth.
...
//                   <h3 className="text-md font-medium text-gray-900">Competitive Advantage</h3>
//                   <p className="text-gray-700 mt-1">
//                     Unlike our competitors, we offer a unique approach that combines innovative
...
//                 <div className="mt-4 pt-4 border-t border-gray-100">
//                   <p className="text-sm text-gray-500">
//                     Request access to detailed documents and financials by sending a
